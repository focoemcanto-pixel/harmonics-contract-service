...
const SECTION_DEFINITION = {
  antesala: { title: 'Antessala', icon: 'antessala', allowDescriptiveContent: true, showConfigFields: true },
  ...
  receptivo: { title: 'Receptivo', icon: 'reception', allowDescriptiveContent: true, showConfigFields: true },
};
