...
function renderSection(title, iconName, items, { titleOverride = '' } = {}) {
                    ...
                    ? `
                      <div class="item-line muted-line">
                        ...
                        <span>
                          ...
                          ${
                            safeReferenceHref
                              ? `<a href="${escapeHtml(safeReferenceHref)}" target="_blank" rel="noreferrer">${escapeHtml(referenceTitle)}</a>`
...
<body>
  <main class="page">
    ...
    ${renderSection('Cortejo', 'cortejo', cortejo)}
