...
function toRepertoirePayload({ configRow, itemRows, fallbackRow }) {
  ...
  return {
    ...
    clientName:
      ...
      base.nome_cliente_noivo ||
      '',
    eventTime: base.event_time || base.horario_evento || base.time || base.horario || '',
    locationName: base.location_name || base.local_evento || base.location || base.local || '',
    formation: base.formation || base.formacao || base.formacao_musical || '',
